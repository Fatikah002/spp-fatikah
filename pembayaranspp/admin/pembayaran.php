<h5>Halaman Pilih Data Siswa Untuk Pembayaran</h5>
 ...
 <table class="table table-striped table-bordered">
 	<tr class="fw-bold">
 		...
 		<td align=center valign=top>SUDAH DIBAYAR</td>
 		<td align=center valign=top>KEKURANGAN</td>
 		<td align=center valign=top>STATUS</td>
 		<td align=center valign=top>HISTORY</td>
 	</tr>
 	<?php
	include '../koneksi.php';
	$no = 1;
	...
	<tr>
		...
		<td>
			<?php
			if($kekurangan==0){
				echo "<center><span class='badge text-bg-success'> Sudah Lunas </span></center>";
			}else{?>
					<center><a href="?url=tambah-pembayaran&nisn=<?= $data['nisn']?>&kekurangan=<?= $kekurangan?>" class="btn btn-warning ">Pilih & Bayar</a> </center>
			<?php }?>
		</td>
		<td>
			<center><a href="?url=history-pembayaran&nisn=<?= $data ['nisn'] ?>" class = "btn btn-primary">History</a></center>
		</td>
	</tr>
	<?php } ?>
</table>

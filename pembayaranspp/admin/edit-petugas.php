...
<form method="post" action="?url=proses-edit-petugas&id_petugas=<?= $id_petugas;?>">
	...
	<div class="form-group mb-2">
		...
		<input value="<?= $data['password']  ?>" type="text" name="password" maxlenght="13" class="form-control" required>
	</div>
	<div class="form-group mb-2">
		<label>Nama Petugas</label>
		<input value="<?= $data['nama_petugas']  ?>" type="text" name="nama_petugas" maxlenght="13" class="form-control" required>
	</div>
	<div class="form-group mb-2">
